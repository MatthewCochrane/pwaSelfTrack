    ...
    <md-app v-if="firestoreReady || currentUser == null" md-waterfall md-mode="fixed" md-scrollbar>
      <md-app-toolbar class="md-primary">
        ...
        <md-button to="/" class="md-plain">
          <h1 class="md-title">Self Track</h1>
        </md-button>
        ...
        <md-menu md-size="big" md-direction="bottom-end" v-if="currentTrack">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      deleteCurrentTrack () {
        this.$store.dispatch('deleteTrack', this.currentTrack.id)
        this.$router.replace('/')
      }
    }
  }
